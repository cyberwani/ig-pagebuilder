(function ($) {
    ...
    JSNModalResize.prototype = {
        resize:function(windowWidth, width, frameId){
            if(windowWidth < 800){
                ...
                window.parent.jQuery.noConflict()( frameId).contents().find('.jsn-bootstrap .form-horizontal .control-label').css('width', '60px');
                window.parent.jQuery.noConflict()( frameId).contents().find('.jsn-bootstrap .form-horizontal .controls').css('margin-left', '80px');
            }
            else{
                ...
                window.parent.jQuery.noConflict()( frameId).contents().find('.jsn-bootstrap .form-horizontal .control-label').css('width', '160px');
                window.parent.jQuery.noConflict()( frameId).contents().find('.jsn-bootstrap .form-horizontal .controls').css('margin-left', '180px');
            }
        }
    }
    ...
    $(document).ready(function() {
        $(window).resize(function() {
            ...
            $('.ui-dialog .ui-dialog-content').css('height', height - 100)
